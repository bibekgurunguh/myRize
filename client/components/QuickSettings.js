...
import { StyleSheet, Text, View, Animated, TouchableOpacity, TouchableWithoutFeedback } from 'react-native';
...
export default function QuickSettings(props) {
  ...
  return (
    <Animated.View style={{...styles.panel, transform: [{scaleY: scaleAnim}, {translateY: moveAnim}]}}>
      <TouchableOpacity style={styles.buttons}
        activeOpacity={0.6} onPress={goSettings}
      >
